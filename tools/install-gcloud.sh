...
set -eux; \
    ...
    export GCLOUD_CLI_VERSION=${GCLOUD_SDK_VERSION:-502.0.0-0} && \
    export GCLOUD_AUTH_VERSION=${GCLOUD_AUTH_VERSION:-502.0.0-0} && \
    ...
    export CLOUD_SQL_PROXY_VERSION=${CLOUD_SQL_PROXY_VERSION:-2.14.1} && \

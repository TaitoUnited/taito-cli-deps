...
set -eux; \
    ...
    export GCLOUD_CLI_VERSION=${GCLOUD_SDK_VERSION:-491.0.0-0} && \
    export GCLOUD_AUTH_VERSION=${GCLOUD_AUTH_VERSION:-491.0.0-0} && \
    ...
    export CLOUD_SQL_PROXY_VERSION=${CLOUD_SQL_PROXY_VERSION:-2.13.0} && \
